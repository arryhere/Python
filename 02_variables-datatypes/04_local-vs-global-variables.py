'''
• local variable: variable that is defined within a function and is only accessible within that function. It is created when the
  function is called and is destroyed when the function returns
• global variable: variable that is defined outside of a function and is accessible anywhere in your code file
'''
...
def demo():
  x = 4  # local variable
  print(f"The value of x is: {x}")  # The value of x is: 4
